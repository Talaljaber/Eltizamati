...
- **The 10-second test:** an active user opening the app answers, without navigation: *What do I owe? What's due next? What changed? Am I on track?*
...
| Estimates | None (only official) | Clearly-labeled estimates *alongside* official figures |
