...
**Basis:** SRC-1 §6, refined. These are *assumption-backed archetypes* (ASM-001), not researched personas — validation tasks are listed at the end.
...
| JTBD-2.3 | I hear "rates changed" in the news | know whether that affects *me* | I don't have to guess or call the bank |
...
**MVP moments that serve Khalil:** Murabaha detail view with correct terminology and *honest limitation labels* ("early-settlement rebate is set by your bank — ask about it"), Islamic education content. Khalil is the persona that most tests PRIN-7; getting him wrong is worse than excluding him.
