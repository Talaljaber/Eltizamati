...
The final `vitest` suite for the `finance-engine` package reports **98.54%** line coverage natively. The coverage gap is entirely restricted to non-critical internal defensive types. The core formula mathematics and persistence boundaries have exhaustive coverage.
...
-------------------|---------|----------|---------|---------|-------------------
All files          |   98.54 |    91.18 |     100 |   98.54 |
```
