...
const en = {
  ...
  'nav.scheduleProposals': 'Schedule Proposals',
  ...
  'bankRateSimulator.currentBenchmark': 'Current CBJ benchmark',
  'bankRateSimulator.margin': 'Bank margin (%)',
  'bankRateSimulator.effectiveRate': 'Effective rate',
  'bankRateSimulator.noBenchmark':
    'No CBJ benchmark has been announced yet — record one on the Benchmark Simulator page first.',
...
const ar: Record<keyof typeof en, string> = {
  ...
  'nav.scheduleProposals': 'مقترحات الجدول',
  ...
  'bankRateSimulator.currentBenchmark': 'مؤشر البنك المركزي الحالي',
  'bankRateSimulator.margin': 'هامش البنك (%)',
  'bankRateSimulator.effectiveRate': 'السعر الفعّال',
  'bankRateSimulator.noBenchmark':
    'لم يتم الإعلان عن مؤشر من البنك المركزي بعد — سجّل واحدًا في صفحة محاكي المؤشر أولاً.',
