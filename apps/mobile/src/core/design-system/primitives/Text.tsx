...
function resolveTextAlign(align: 'start' | 'end' | 'center' | undefined): 'left' | 'right' | 'center' | undefined {
...
export type TextColor = 'primary' | 'secondary' | 'tertiary' | 'brand' | 'critical' | 'positive' | 'caution'
 ...
 */
export function Text({ variant = 'body', color = 'primary', align, children, ...rest }: TextPropsDS) {
